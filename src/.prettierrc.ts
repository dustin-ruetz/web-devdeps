export const prettierConfig = {
	...
	printWidth: 80,
	/**
	 * Don't wrap lines when formatting text in Markdown files since some services
	 * use a linebreak-sensitive renderer, e.g. GitHub comments.
	 */
	proseWrap: "preserve",
	...
	trailingComma: "all",
	/** Refer to .editorconfig file for the advantages of using tabs over spaces for indentation. */
	useTabs: true,
};
